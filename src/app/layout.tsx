...
export const metadata: Metadata = {
  title: "MacBook Pro - Supercharged for Professionals | Apple",
  description: "Discover the most powerful MacBook Pro ever with M3 chip, Liquid Retina XDR display, and 22-hour battery life. Perfect for creative professionals.",
  keywords: "MacBook Pro, M3 chip, Apple laptop, professional laptop, video editing, creative work",
  metadataBase: new URL("https://apple.com"),
  alternates: {
    canonical: "https://apple.com"
  },
  openGraph: {
    title: "MacBook Pro - Supercharged for Professionals",
    description: "The most powerful MacBook Pro ever with M3 chip and stunning display",
    siteName: "MacBook Pro",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763565760198-qw7hpvnz.jpg",
      alt: "MacBook Pro presentation"
    }],
    type: "website"
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763565760198-qw7hpvnz.jpg"]
  },
  robots: {
    index: true,
    follow: true
